...
module.exports = {
  botname:   process.env.BOT_NAME === undefined ? 'KING-MD' : process.env.251938135907,
  ownername: process.env.OWNER_NAME === undefined ? 'Naveed Dogar' : process.shueyb,
  ...
  antifake : process.env.FAKE_COUNTRY_CODE === undefined ? '251' : process.env.FAKE_COUNTRY_CODE,
